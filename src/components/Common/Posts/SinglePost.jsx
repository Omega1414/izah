  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content={postImg || "https://yourwebsite.com/path/to/default-image.jpg"} />
        ...
        <meta name="twitter:description" content={desc || "Default description"} />
        <meta name="twitter:image" content={postImg || "https://yourwebsite.com/path/to/default-image.jpg"} />
