...
const FollowingModal = ({ modal, setModal, follows }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-darkBg w-96 h-auto p-6 rounded-lg shadow-lg"
        onClick={handleModalClick}  // Prevent closing modal when clicking inside
      >
        <div className="flex justify-end mb-4">
          <button onClick={() => setModal(false)} className="text-gray-500 dark:text-darkText dark:hover:text-gray-300 hover:text-gray-800">
